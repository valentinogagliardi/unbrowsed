...
from unbrowsed import parse_html, get_by_text, MultipleElementsFoundError, NoElementsFoundError
...
def test_get_by_text_prioritize_child():
    ...
    """
    dom = parse_html(html)
    assert get_by_text(dom, "Invalid email address or password. Please correct and try again.") is not None
